...
model_path = "/corpora/InstructTune/llama/llama_2_hf/llama-2-7b/7bweights"
...
# # print(f"Maximum string length in 140k prompts: {max_token_length}") #11225
# avg_token_length = total_tokens / len(prompts)
# print(f"Average string length in 140k prompts: {avg_token_length}") #
