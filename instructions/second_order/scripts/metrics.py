...
if __name__=='__main__':
    ...
    preds_dir = f"./datasets/test/{data_set}/"
    if args.ftype:
        preds_rs1 = preds_dir + f'{sample_type}_{args.ftype}_{n_instances}_formatted_det_rs_2021.json'
        preds_rs2 = preds_dir + f'{sample_type}_{args.ftype}_{n_instances}_formatted_det_rs_2022.json'
        preds_rs3 = preds_dir + f'{sample_type}_{args.ftype}_{n_instances}_formatted_det_rs_2023.json'
    else:
        preds_rs1 = preds_dir + f'{sample_type}_{n_instances}_formatted_det_rs_2021.json'
        preds_rs2 = preds_dir + f'{sample_type}_{n_instances}_formatted_det_rs_2022.json'
        preds_rs3 = preds_dir + f'{sample_type}_{n_instances}_formatted_det_rs_2023.json'

    gts_path = f'./datasets/data/iw/test_gts.json'
    ...
    print(f'For {filename}_{data_set}:\n\n rouge1:{camel_rouge_l_mean1} cos1:{camel_cossims_mean1} perp1:{camel_perp1} \
    \n rouge2:{camel_rouge_l_mean2} cos2:{camel_cossims_mean2} perp2:{camel_perp2} \
    \n rouge3:{camel_rouge_l_mean3} cos3:{camel_cossims_mean3} perp3:{camel_perp3} \
